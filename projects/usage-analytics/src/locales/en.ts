...
const messages = Utils.merge({}, enCore, enUtils, enNotification, enUserSettings, enFeedback, enFacet, enModal, enAdvanced, enHeatmap, enTimeline, enFilters, appMessages);
